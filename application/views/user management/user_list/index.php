		...
		<div id="inner-wrapper">
				...
				<div class="section-header text-right">
					...
					<div class="filter-group">
						<select name="param" class="form-control filter1">
							...
							<option value="user_group_id">Group</option>
						</select>
			...
			<section>
				<div class="section-content">
					<a href="<?=base_url('user_management/user_list/insert')?>"><button class="btn btn-primary btn-atas">ADD NEW USER</button></a></br></br>
			...
			<script type="text/javascript">
				...
				$(document).ready(function() {
					...
					table = $('#dataTableAsset').DataTable({
						...
						"ajax": {
							"url" : "<?=base_url('user_management/get_data_user_list')?>",
							"type" : "POST",
							"data" : function (d) {
