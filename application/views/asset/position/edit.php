<div class="col-sm-10 col-sm-offset-2">
	...
	<section>
		<form method="post" action="<?= base_url('asset/position/update') ?>">
			<div class="table-category-header">
				ASSET ADD
			</div>
			<div class="form-group form-inline">
				<label for="email">Asset Name:</label>
				<input type="hidden" name="id" class="form-control" required style="width:25%" value="<?= $position->position_id ?>">
				<input type="text" name="position_name" class="form-control" placeholder="Position Name" required style="width:25%" value="<?= $position->position_name ?>">
			</div>
