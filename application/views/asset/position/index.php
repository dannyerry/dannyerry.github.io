		...
		<div id="inner-wrapper">
			<section>
				<div class="section-header text-right">
					...
					<div class="filter-group">
						<input type="text" class="form-control value1" name="value" placeholder="Search Position Name">
			...
			<section>
				<div class="section-content">
					<a href="<?=base_url('asset/position/insert')?>"><button class="btn btn-primary btn-atas">ADD NEW DEPARTMENT</button></a></br></br>
			...
			<script type="text/javascript">
				...
				$(document).ready(function() {
					...
					table = $('#dataTableAsset').DataTable({
						...
						"ajax": {
							"url" : "<?=base_url('asset/position/get_position_list')?>",
							"type" : "POST",
							"data" : function (d) {
								if ( $('.value1').val() != '') {
									d.value1 = $('.value1').val();
