...
<div class="col-sm-10 col-sm-offset-2">
    ...
    <form method="post" id="myForm" action="<?= base_url('asset/stocktransfer/do_insert')?>">
		<section>		
			...
			<table class="master-table" id="myTable">
				...
				<tr>
					<td>Due Date</td>
					<td><input type="text" name="duedate" id="ddd" class="form-control" required></td>
				</tr>
				<tr>
					<td>Reference</td>
					<td>
		...
		<section>
			...
			<strong>INVENTORY</strong>
				...
				<br /><strong>Notes :</strong><textarea id="notes" class="form-control" name="notes" style="resize:none" placeholder="Notes .. " required></textarea>
			</div>
		</section>
		<section>
...
<script>
	function do_insert(){
		...
		$('#arrayDataInsertAsset').val(dataAs);
		$('#arrayDataInsertInventory').val(dataIn);
