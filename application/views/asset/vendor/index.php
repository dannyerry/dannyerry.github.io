...
<div class="col-sm-10 col-sm-offset-2">
	...
	<div id="content-wrapper">
		<div id="inner-wrapper">
			...
			<section>
                ...
                <a href="<?=base_url('asset/MaintenanceVendor/insert')?>"><button class="btn btn-primary">NEW</button></a>
	...
	$(document).ready(function() {
		...
		table = $('#stockTransfer').DataTable({
			...
			"ajax": {
				"url" : "<?=base_url('asset/MaintenanceVendor/get_maintenance_vendor_list')?>",
				"type" : "POST",
				"data" : function (d) {
