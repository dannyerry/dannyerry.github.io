<div class="col-sm-10 col-sm-offset-2">
	<div class="breadcrumb-menu">
		<ol class="breadcrumb">
			...
			<li><a href="<?=base_url('asset/department')?>">DEPARTMENT</a></li>
	...
	<section>
		<form method="post" action="<?= base_url('asset/department/update') ?>">
			<div class="table-category-header">
				DEPARTMENT EDIT
			</div>
			<div class="form-group form-inline">
				<label for="email">Department Name:</label>
				<input type="hidden" name="id" class="form-control" required style="width:25%" value="<?= $department->department_id ?>">
				<input type="text" name="dept_name" class="form-control" placeholder="Department Name" required style="width:25%" value="<?= $department->department_name ?>">
			</div>
