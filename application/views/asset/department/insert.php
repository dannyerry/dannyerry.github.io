<div class="col-sm-10 col-sm-offset-2">
	...
	<section>
		<form method="post" action="<?= base_url('asset/department/do_insert') ?>">
			<div class="table-category-header">
				DEPARTMENT ADD
			</div>
			<div class="form-group form-inline">
				<label for="email">Department Name:</label>
				<input type="text" name="dept_name" class="form-control" placeholder="Department Name" required style="width:25%">
			</div>
