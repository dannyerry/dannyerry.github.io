<div class="col-sm-10 col-sm-offset-2">
	<div class="breadcrumb-menu">
		<ol class="breadcrumb">
			...
			<li class="active">STOCK OPNAME REALISASI ON PROGRESS</li>
		</ol>
	</div>
	<div id="content-wrapper">
		<div id="inner-wrapper">
            <form action="<?= base_url('asset/stockopname/update_realisasi_progress') ?>" method="post" id="myForm">
            ...
            &nbsp;
				<section>
					<div class="section-content">
						<button type="button" class="btn btn-success" onclick='do_update(2)'>Save As Draft</button>
						<button type="button" class="btn btn-primary"  onclick='do_update(3)'>Submit</button>
